Feature: QA Tester Interview Sample

  Scenario: Problem One
    Given Open URL
    And Need to verify the right count of values appear on the screen
    And Need to verify the values on the screen are greater than 0
